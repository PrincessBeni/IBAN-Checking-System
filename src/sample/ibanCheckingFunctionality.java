...
public class ibanCheckingFunctionality {
    ...
    public static int testIban(String a) {
                    //take out spaces from the input
                    String addedAccountNumber = a.trim();
                    ...
                    if (ibanNumber.mod(modNumber).intValue() == 1) {
                        anotherValidationAlert.alert("Outcome", a  + " is a VALID IBAN. Do you want to validate another IBAN?");
                        return 0;


                    } else {
                        anotherValidationAlert.alert("Outcome", a + " is INVALID IBAN. Do you want to validate another IBAN?");
                        return 0;
                    }
    }
